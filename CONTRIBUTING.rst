...
aioh2 could always use more documentation, whether as part of the
official aioh2 docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork the `aioh2` repo on GitHub.
...
3. The pull request should work for Python 3.3, 3.4 and 3.5, and for PyPy. Check
   https://travis-ci.org/decentfox/aioh2/pull_requests
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_aioh2
